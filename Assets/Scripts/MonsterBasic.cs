...
public class MonsterBasic : MonoBehaviour
{
    ...
    public hang_around hang_AroundScript;
    ...
    public void ActiveHangAround()
    {
        if (hang_AroundScript==null)
        {
            hang_AroundScript = GetComponent<hang_around>();
        }
        hang_AroundScript.enabled = true;
    }
    ...
    public void ExecuteClassSkill()
    {
        ...
        switch (monsterData.monsterClass)
        {
            ...
            case MonsterClass.Tanker:
                ...
                SetAttack();
                hang_AroundScript.enabled = false;
                break;
        }
        Invoke(nameof(SetIdle), monsterData.attackSpriteContinueTime);
        Invoke(nameof(ActiveHangAround), monsterData.attackSpriteContinueTime);
    }
